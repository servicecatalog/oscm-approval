...
public class AppDataService {
    ...
    DataSource findDatasource() throws Exception {
        if (ds == null) {
            try {
                ...
                throw new Exception(
                        "APP Datasource '" + DATASOURCE + "' not found.", e);
            }
        }
        return ds;
    }
    ...
    public String loadInstancename(String instanceId) throws Exception {
        ...
        String sql = "SELECT parametervalue as instancename FROM instanceparameter WHERE serviceinstance_tkey = (SELECT tkey FROM serviceinstance WHERE instanceid = ?) AND parameterkey = 'INSTANCENAME'";
        ...
        if (instancename == null) {
            throw new RuntimeException(
                    "Failed to retrieve instancename for instanceId: " + instanceId);
        }
    ...
    private String loadControllerOwnerPassword() throws Exception {
        String sql = "SELECT settingvalue FROM configurationsetting WHERE settingkey = 'BSS_USER_PWD' AND controllerid = 'ess.vmware'";
        String userPwd = null;
        ...
        if (userPwd == null) {
            throw new RuntimeException(
                    "Failed to retrieve password for controller owner");
        }

        if (userPwd.startsWith(CRYTO_PREFIX)) {
            return userPwd.substring(userPwd.indexOf(":") + 1,
                    userPwd.length());
        }
    ...
    private String loadControllerOwnerUserId() throws Exception {
        String sql = "SELECT settingvalue FROM configurationsetting WHERE settingkey = 'BSS_USER_ID' AND controllerid = 'ess.vmware'";
        String userId = null;
        ...
        if (userId == null) {
            throw new RuntimeException(
                    "Failed to retrieve userId for controller owner");
        }

        return userId;
    }

    private String loadControllerOwnerUserKey() throws Exception {
        String sql = "SELECT settingvalue FROM configurationsetting WHERE settingkey = 'BSS_USER_KEY' AND controllerid = 'ess.vmware'";
        String userKey = null;
        ...
        if (userKey == null) {
            throw new RuntimeException(
                    "Failed to retrieve userKey for controller owner");
        }

        return userKey;
    }

    public Credentials loadOrgAdminCredentials(String organizationId)
            throws Exception {
    ...
    private String loadUserId(String orgId) throws Exception {
        String sql = "SELECT settingvalue FROM configurationsetting WHERE settingkey = ? AND controllerid = 'ess.vmware'";
    ...
    private long loadUserKey(String orgId) throws Exception {
        String sql = "SELECT settingvalue FROM configurationsetting WHERE settingkey = ? AND controllerid = 'ess.vmware'";
    ...
    private String loadUserPwd(String orgId) throws Exception {
        String sql = "SELECT settingvalue FROM configurationsetting WHERE settingkey = ? AND controllerid = 'ess.vmware'";
        String userPwd = null;
    ...
    public HashMap<String, String> loadControllerSettings() throws Exception {
        String sql = "SELECT settingkey,settingvalue FROM configurationsetting WHERE controllerid = 'ess.vmware'";
    ...
    public String loadBesWebServiceWsdl() throws SQLException, Exception {
        String sql = "SELECT settingvalue FROM bssappuser.configurationsetting WHERE settingkey = 'BSS_WEBSERVICE_WSDL_URL' AND controllerid = 'PROXY'";
    ...
    public String loadBesWebServiceUrl() throws SQLException, Exception {
        String sql = "SELECT settingvalue FROM bssappuser.configurationsetting WHERE settingkey = 'BSS_WEBSERVICE_URL' AND controllerid = 'PROXY'";
        ...
        throw new RuntimeException(
                "Failed to retrieve the BSS web service URL from the APP database");
    }
