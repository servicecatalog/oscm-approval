...
/**
 * Start RMP processes or approve trigger directly without starting an RMP
 * process.
 */
@SuppressWarnings("deprecation")
public class ApprovalTask {
    private final static Logger log = LoggerFactory.getLogger(ApprovalTask.class);

    private final static String AUTO_APPROVE_TRIGGER = "AUTO_APPROVE_TRIGGER";
    ...
    /**
     * This constructor is used for triggers like <b>billingPerformed</b> and
     * <b>onCancelAction</b>. These triggers do not provide information on the
     * process or service.
     * 
     * @param trigger
    ...
    /**
     * This constructor is used for triggers that provide process and service
     * information.
     * 
     * @param trigger
     *            The name of the trigger
    ...
    public ApprovalTask(String trigger, VOTriggerProcess process, VOService service)
        ...
        if (service != null) {
            ...
            for (VOParameter par : service.getParameters()) {
                log.debug("VOParameter: " + par.getParameterDefinition().getParameterId() + ", "
                        + par.getValue());
    ...
    /**
     * Start RMP process or approve trigger directly without starting an RMP
     * process.
     */
    public void startApprovalProcess() throws Exception {
        ...
        boolean autoApprove = (autoApproveKeyDefined && param != null
                && param.value.equalsIgnoreCase("true"));
    ...
    private void excecuteProcess(String processFilename, String mailSubject, String mailBody)
            throws Exception {
        Task task = new Task();
    ...
    private VOUserDetails getUserDetails(final VOUser user) throws Exception {
        ...
        return (VOUserDetails) BesClient.runWebServiceAsOrganizationAdmin(customerOrgId,
                createGetUserDetailsWSCall(IdentityService.class, user));
    }
