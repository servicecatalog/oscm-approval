...
@PrepareForTest({EmailWriter.class, Properties.class, Session.class, Context.class, Transport.class, LogManager.class})
public class EmailWriterTest {
    ...
    public void testTransmitReceiveDataOnce() throws Exception {
        ...
        PowerMockito.doNothing().when(this.emailWriter, PowerMockito.method(EmailWriter.class, "sendEmail")).withArguments(eq(this.transmitData));
